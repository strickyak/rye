...
func FnContainsJ(uc U, vc V, ue U, ve V) bool {
	...
	switch /*noinline:*/Tag(uc,  vc) {
	case Py:
		p := /*noinline:*/TakePJ(uc,  vc)
		return p.Contains(ue, ve)
	case Int:
		panic("Cannot FnContainsJ from int")
	case Str:
    s := /*noinline:*/TakeStrJ(uc,  vc)
    e := string(StrJ(ue, ve))
...
func FnSetItemJ(c PJ, ui U, vi V, ue U, ve V) {
	...
	switch /*noinline:*/Tag(ui,  vi) {
	case Py:
    a := /*noinline:*/TakePJ(ui,  vi)
		panic(F("SetItem: Bad index type: %s", a.TypeName()))
	case Int:
    a := /*noinline:*/TakeIntJ(ui,  vi)
		c.SetItemInt(int(a), ue, ve)
    return
	case Str:
    a := /*noinline:*/TakeStrJ(ui,  vi)
...
func FnGetItemSliceJ(a1 U, a2 V, b1 U, b2 V, c1 U, c2 V) (U, V) {
	...
	n := int64(/*noinline:*/LenJ(a1,  a2))

	// start point b
	b, bok := /*noinline:*/IntOkOrNone(b1,  b2)
	if !bok {
		b = 0
	}
	if b < 0 {
	...
	// limit point c
	c, cok := /*noinline:*/IntOkOrNone(c1,  c2)
	if !cok {
		c = n
	}
	if c < 0 {
...
func (o *JBase) Is(a_1 U, a_2 V) bool {
	var o1 U
	var o2 V
 /*macro:MkPJ{*/   var _827__b *JBase = (o).GetJBase();   var _827__u U = Py + 16;   var _827__v V = V(unsafe.Pointer(_827__b));   _,_ = _827__u, _827__v;  /*macro}*/ 	o1, o2 = _827__u, _827__v
	return o1 == a_1 && o2 == a_2
}
func (o *JBase) IsNot(a_1 U, a_2 V) bool {
	var o1 U
	var o2 V
 /*macro:MkPJ{*/   var _838__b *JBase = (o).GetJBase();   var _838__u U = Py + 16;   var _838__v V = V(unsafe.Pointer(_838__b));   _,_ = _838__u, _838__v;  /*macro}*/ 	o1, o2 = _838__u, _838__v
	return o1 != a_1 || o2 != a_2
}
...
func (o *JBase) Compare_Py(b PJ) int {
 ...
 /*macro:OperatorCompare{*/   var _917__z int;   if (x) < ( y) {     _917__z = -1;   } else if (x) > ( y) {     _917__z = 1;   };  /*macro}*/ 	return _917__z
}
...
func (o *JBool) Compare_Py(b PJ) int {
	...
	switch t := b.(type) {
	case *JBool:
 /*macro:OperatorCompare{*/   var _1053__z int;   if (o.I) < ( t.I) {     _1053__z = -1;   } else if (o.I) > ( t.I) {     _1053__z = 1;   };  /*macro}*/ 		return _1053__z
	case *JFloat:
 /*macro:OperatorCompare{*/   var _1062__z int;   if (o.F) < ( t.F) {     _1062__z = -1;   } else if (o.F) > ( t.F) {     _1062__z = 1;   };  /*macro}*/ 		return _1062__z
...
func (o *JFloat) Compare_Int(b int64) int {
  f := float64(b)
 /*macro:OperatorCompare{*/   var _1106__z int;   if (o.F) < ( f) {     _1106__z = -1;   } else if (o.F) > ( f) {     _1106__z = 1;   };  /*macro}*/   return _1106__z
}
...
func (o *JFloat) Compare_Py(b PJ) int {
	...
	switch t := b.(type) {
	case *JBool:
 /*macro:OperatorCompare{*/   var _1122__z int;   if (o.F) < ( t.F) {     _1122__z = -1;   } else if (o.F) > ( t.F) {     _1122__z = 1;   };  /*macro}*/ 		return _1122__z
	case *JFloat:
 /*macro:OperatorCompare{*/   var _1131__z int;   if (o.F) < ( t.F) {     _1131__z = -1;   } else if (o.F) > ( t.F) {     _1131__z = 1;   };  /*macro}*/ 		z := _1131__z
...
func Proto1J(a_1 U, a_2 V) (U, V) {
	...
	case Py:
		...
		a := /*noinline:*/TakePJ(a_1,  a_2)
		_ = a
		panic("Proto1J: on Py & Py")
	case Int:
		a := /*noinline:*/TakeIntJ(a_1,  a_2)
		_ = a
		panic("Proto1J: on Int & Py")
	case Str:
		a := /*noinline:*/TakeStrJ(a_1,  a_2)
		_ = a
...
func StrJ(a_1 U, a_2 V) string {
	...
	case Py:
		...
		s := /*noinline:*/TakePJ(a_1,  a_2)
		return s.Str()
	case Int:
		panic("StrJ: got an Int")
	case Str:
		return /*noinline:*/TakeStrJ(a_1,  a_2)
	}
	panic("StrJ: WTF")
}
...
func MkTupleVUV(pp ...W) (U, V) {
	z := &JTuple{JList{PP: pp}}
	ForgeJ(z)
 /*macro:MkPJ{*/   var _1754__b *JBase = (z).GetJBase();   var _1754__u U = Py + 16;   var _1754__v V = V(unsafe.Pointer(_1754__b));   _,_ = _1754__u, _1754__v;  /*macro}*/ 	return _1754__u, _1754__v
}
...
func MkListVUV(pp ...W) (U, V) {
	z := &JList{PP: pp}
	ForgeJ(z)
 /*macro:MkPJ{*/   var _1770__b *JBase = (z).GetJBase();   var _1770__u U = Py + 16;   var _1770__v V = V(unsafe.Pointer(_1770__b));   _,_ = _1770__u, _1770__v;  /*macro}*/ 	return _1770__u, _1770__v
}
...
func MkDictVJ(pp ...W) (U,V) {
	...
	z := &JDict{ppp: zzz}
	ForgeJ(z)
 /*macro:MkPJ{*/   var _1795__b *JBase = (z).GetJBase();   var _1795__u U = Py + 16;   var _1795__v V = V(unsafe.Pointer(_1795__b));   _,_ = _1795__u, _1795__v;  /*macro}*/   return _1795__u, _1795__v
}

func MkStrsJ(ss []string) *JList {
	pp := make([]W, len(ss))
	for i, s := range ss {
		u1, u2 := /*noinline:*/MkStrJ(s)
		pp[i] = W{u1, u2}
	}
	return MkListJ(pp)
}
...
func MkBytUV(bb []byte) (U,V) {
  z := &JByt{YY: bb}
  ForgeJ(z)
 /*macro:MkPJ{*/   var _1816__b *JBase = (z).GetJBase();   var _1816__u U = Py + 16;   var _1816__v V = V(unsafe.Pointer(_1816__b));   _,_ = _1816__u, _1816__v;  /*macro}*/   return _1816__u, _1816__v
}
...
func FnCompare(a1 U, a2 V, b1 U, b2 V) int {
 ...
 /*macro:OperatorCompare{*/   var _1925__z int;   if (a) < ( b) {     _1925__z = -1;   } else if (a) > ( b) {     _1925__z = 1;   };  /*macro}*/ 			return _1925__z
		case Str:
			// Int < Str
			return -1
		}
 ...
 /*macro:OperatorCompare{*/   var _1951__z int;   if (a) < ( b) {     _1951__z = -1;   } else if (a) > ( b) {     _1951__z = 1;   };  /*macro}*/ 			return _1951__z
		}
	}
...
func ListJ(u U, v V) []W {
	...
	case Str:
		var ww []W
		s := /*noinline:*/TakeStrJ(u,  v)
		for _, ch := range s {
			u9, v9 := /*noinline:*/MkintJ(int(ch))
		...
		for i := 0; true; i++ {
			if on <= i {
				...
				if bn <= i {
					...
					oppi := o.PP[i]
					bppi := b.PP[i]
					cmp := /*noinline:*/CompareJ(oppi.U,  oppi.V,  bppi.U,  bppi.V)
					if cmp != 0 {
						return cmp
					}
...
func (o *JTuple) Mod_StrRev(s string) (U, V) {
  ...
  for i:=0; i<n; i++ {
    w := o.PP[i]
    switch /*noinline:*/Tag(w.U,  w.V) {
    case Py:
      p := /*noinline:*/TakePJ(w.U,  w.V)
      //log.Println("Mod_StrRev: i=", i, "u=", w.U, "v=", w.V, "p=", p, "p.TypeName=", p.TypeName())
      if (p != nil) {
        aa[i] = p.Contents()
      }
    case Int:
      aa[i] = /*noinline:*/TakeIntJ(w.U,  w.V)
    case Str:
      aa[i] = /*noinline:*/TakeStrJ(w.U,  w.V)
    }
  }
  z := fmt.Sprintf(s, aa...)
...
func (o *JTuple) Add_Py(a PJ) (U, V) {
	...
	v = append(v, b...)
	z := MkTupleJ(v)
 /*macro:MkPJ{*/   var _2138__b *JBase = (z).GetJBase();   var _2138__u U = Py + 16;   var _2138__v V = V(unsafe.Pointer(_2138__b));   _,_ = _2138__u, _2138__v;  /*macro}*/ 	return _2138__u, _2138__v
}
...
func (o *JList) Add_Py(a PJ) (U, V) {
	...
	v = append(v, b...)
	z := MkListJ(v)
 /*macro:MkPJ{*/   var _2181__b *JBase = (z).GetJBase();   var _2181__u U = Py + 16;   var _2181__v V = V(unsafe.Pointer(_2181__b));   _,_ = _2181__u, _2181__v;  /*macro}*/ 	return _2181__u, _2181__v
}
func (o *JList) Contents() interface{}     { return o.PP }
func (o *JList) Bool() bool                { return len(o.PP) != 0 }
func (o *JList) Contains(u U, v V) bool {
	for _, x := range o.PP {
 /*macro:EQJ{*/  /*macro}*/  /*macro:JRelOp{*/   var _2193__rel bool;   if ((x.U)&7) == Int && ((  u)&7) == Int {     _2193__ia := /*noinline:*/TakeIntJ(x.U,    x.V);     _2193__ib := /*noinline:*/TakeIntJ(  u,    v);  /*macro:Operator_EQ{*/  /*macro}*/     _2193__rel = ((_2193__ia) == ( _2193__ib));   } else if ((x.U)&7) == Str && ((  u)&7) == Str {     _2193__sa := /*noinline:*/TakeStrJ(x.U,    x.V);     _2193__sb := /*noinline:*/TakeStrJ(  u,    v);  /*macro:Operator_EQ{*/  /*macro}*/     _2193__rel = ((_2193__sa) == ( _2193__sb));   } else {     _2193__rel =  FnEQ(x.U,   x.V,   u,   v);   };  /*macro}*/ 		if _2193__rel {
			return true
		}
	}
	return false
...
func (o *JList) GetItemSlice(i, j int) (U, V) {
	...
	r := MkListJ(o.PP[i:j])
 /*macro:MkPJ{*/   var _2249__b *JBase = (r).GetJBase();   var _2249__u U = Py + 16;   var _2249__v V = V(unsafe.Pointer(_2249__b));   _,_ = _2249__u, _2249__v;  /*macro}*/ 	return _2249__u, _2249__v
}
