...
func BenchmarkAssignMSlow(b *testing.B) {
	var sum int64
	for i := 0; i < b.N; i++ {
		sum += JInt(AddMSlow(Mkint(i), Mkint(i*i)))
	}
	//println("BenchmarkAssignMSlow", b.N, sum)
}

func BenchmarkAssignMSlowVar(b *testing.B) {
	var sum int64
	for i := 0; i < b.N; i++ {
		sum += JInt(AddMSlowVar(Mkint(i), Mkint(i*i)))
	}
	//println("BenchmarkAssignMSlowVar", b.N, sum)
}

func BenchmarkAssignMSlowSink(b *testing.B) {
	var sum int64
	for i := 0; i < b.N; i++ {
		sum += JInt(AddMSlowSink(Mkint(i), Mkint(i*i)))
	}
	//println("BenchmarkAssignMSlowSink", b.N, sum)
}

func BenchmarkAssignMFast(b *testing.B) {
	var sum int64
	for i := 0; i < b.N; i++ {
		sum += JInt(AddMFast(Mkint(i), Mkint(i*i)))
	}
	//println("BenchmarkAssignMFast", b.N, sum)
}
