...
// @ 2391 @ 109 @ chr
// { native F
t1 := /*noinline:*/TakeIntJ(a_x_1,  a_x_2)
...
// Vfor: var=<parse.Tvar object at 0x7f20be129e90> i=__101 ptv=/*Yvar.str*/a_vec_1, a_vec_2
   ...
   for_returning__101_1, for_returning__101_2 := func () (U,V) { // around FOR
     var nextee PJ = /*noinline:*/TakePJ(/*Yvar.str*/a_vec_1,  a_vec_2)
...
// Calling DoAssign because isinstance(lhs <class 'codegen2.Yvar'>, Ybase)
/*G.DoAssign*/ /*Yvar.str*/v_z_1, v_z_2 = /*DoAdd*/ /*noinline:*/AddJ( uu_102_1, uu_102_2 ,   uu_103_1, uu_103_2 )
// $ 2654 $ 119 $
...
z := MkListJ(ListJ(a_x_1, a_x_2))
 /*macro:MkPJ{*/   var _790__b *JBase = (z).GetJBase();   var _790__u U = Py + 16;   var _790__v V = V(unsafe.Pointer(_790__b));   _,_ = _790__u, _790__v;  /*macro}*/ return _790__u, _790__v
// } native F
// $ 3488 $ 174 $
...
var jspecFunc_dict = JCallSpec{Name: "dict", Args: []string{}, Defaults: []W{}, Star: "args", StarStar: "kv"}
 ...
 func (o *jpFunc_dict) Contents() interface{} {
   return /*noinline:*/TakePJ(H_dict_1,  H_dict_2)
 }
 ...
 /*macro:MkPJ{*/   var _845__b *JBase = (star).GetJBase();   var _845__u U = Py + 16;   var _845__v V = V(unsafe.Pointer(_845__b));   _,_ = _845__u, _845__v;  /*macro}*/    su, sv := _845__u, _845__v
 /*macro:MkPJ{*/   var _851__b *JBase = (starstar).GetJBase();   var _851__u U = Py + 16;   var _851__v V = V(unsafe.Pointer(_851__b));   _,_ = _851__u, _851__v;  /*macro}*/    ssu, ssv := _851__u, _851__v
...
// { native F
    ...
    x := /*noinline:*/TakePJ(a_x_1,  a_x_2)
    l := x.List()
    t := MkTupleJ(l)
 /*macro:MkPJ{*/   var _877__b *JBase = (t).GetJBase();   var _877__u U = Py + 16;   var _877__v V = V(unsafe.Pointer(_877__b));   _,_ = _877__u, _877__v;  /*macro}*/     return _877__u, _877__v
...
// { native F
    ...
    switch /*noinline:*/Tag(a_x_1,  a_x_2) {
    case Int:
      //a := /*noinline:*/TakeIntJ(a_x_1,  a_x_2)
      return H_int_1, H_int_2
    case Str:
      //a := /*noinline:*/TakeStrJ(a_x_1,  a_x_2)
      return H_str_1, H_str_2
    case Py:
      a := /*noinline:*/TakePJ(a_x_1,  a_x_2)
      return a.PType()
    }
    panic("Bad")
...
self.mu.Unlock()
p := MkDictJ(z)
 /*macro:MkPJ{*/   var _975__b *JBase = (p).GetJBase();   var _975__u U = Py + 16;   var _975__v V = V(unsafe.Pointer(_975__b));   _,_ = _975__u, _975__v;  /*macro}*/ return _975__u, _975__v
// } native F
// $ 7151 $ 360 $
...
for k, v := range self.ppp {
 ...
 /*macro:MkPJ{*/   var _1004__b *JBase = (tup).GetJBase();   var _1004__u U = Py + 16;   var _1004__v V = V(unsafe.Pointer(_1004__b));   _,_ = _1004__u, _1004__v;  /*macro}*/   u, v := _1004__u, _1004__v
  z = append(z, W{u,v})
}
self.mu.Unlock()
p := MkListJ(z)
 /*macro:MkPJ{*/   var _1014__b *JBase = (p).GetJBase();   var _1014__u U = Py + 16;   var _1014__v V = V(unsafe.Pointer(_1014__b));   _,_ = _1014__u, _1014__v;  /*macro}*/ return _1014__u, _1014__v
// } native F
// $ 7355 $ 369 $
...
// Yprim: constructing Yself with {'s': 'self', 'flavor': '', 't': <parse.Tvar object at 0x7f20be0cf490>}
 /*macro:MkPJ{*/   var _1043__b *JBase = (&self.JBase).GetJBase();   var _1043__u U = Py + 16;   var _1043__v V = V(unsafe.Pointer(_1043__b));   _,_ = _1043__u, _1043__v;  /*macro}*/ uu_106_1, uu_106_2 := /*General*/ /*invoker*/ JF_INVOKE_0_items(/*Yself.str*/_1043__u, _1043__v, ) 
...
var jspecFunc__force_generation_of_call_4_ = JCallSpec{Name: "_force_generation_of_call_4_", Args: []string{"f", "a", "b", "c", "d"}, Defaults: []W{W{0,V0}, W{0,V0}, W{0,V0}, W{0,V0}, W{0,V0}}, Star: "", StarStar: ""}
 ...
 func (o *jpFunc__force_generation_of_call_4_) Contents() interface{} {
   return /*noinline:*/TakePJ(H__force_generation_of_call_4__1,  H__force_generation_of_call_4__2)
 }
...
func JF_INVOKE_0___init__(fn_1 U, fn_2 V, ) (U,V) {
  fn := /*noinline:*/CheckTakePJ(fn_1,  fn_2)
  switch x := fn.(type) {   
...
func JF_GET___init__(h_1 U, h_2 V) (U,V) {
  if /*noinline:*/Tag(h_1,  h_2) != Py { panic("cannot GET Field on int or str") }
  h := /*noinline:*/TakePJ(h_1,  h_2)
  switch x := h.(type) { 
  case JI_GET___init__:         
